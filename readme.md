...
A Codecademy project to add interactivity to a piano keyboard with DOM events. 

## Note:

This project was a task from Codecademy. All of the HTML and CSS was already complete, along with some of the main.js file. I then worked through the steps to complete the project and get the interactive piano keys to function correctly. 

As such, this is not my work. I am choosing to store this in a repo as I thought it was a cool, fun project I enjoyed that would be good to reference further down the line. 

I have included the steps from the Codecademy tutorial page below for reference. 
______________
